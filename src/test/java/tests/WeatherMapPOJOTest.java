...
public class WeatherMapPOJOTest {
    ...
    public void registerStationAPIWithPOJO(String external_id, String name, String latitude, String longitude, String altitude) {
        weatherMapVerification.registerStationAPIWithPOJO(external_id, name, latitude, longitude, altitude);
    }
